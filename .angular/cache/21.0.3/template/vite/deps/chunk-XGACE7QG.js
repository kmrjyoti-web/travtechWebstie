...
var b = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  if (s2(a2) && n.transform !== "strict") {
    let { primitive: L, semantic: te, extend: re2 } = a2, f2 = te || {}, { colorScheme: K2 } = f2, A2 = v2(f2, ["colorScheme"]), x2 = re2 || {}, { colorScheme: X } = x2, G2 = v2(x2, ["colorScheme"]), p = K2 || {}, { dark: U } = p, B = v2(p, ["dark"]), y = X || {}, { dark: I } = y, H2 = v2(y, ["dark"]), W2 = s2(L) ? this._toVariables({ primitive: L }, n) : {}, q2 = s2(A2) ? this._toVariables({ semantic: A2 }, n) : {}, Z = s2(B) ? this._toVariables({ light: B }, n) : {}, pe = s2(U) ? this._toVariables({ dark: U }, n) : {}, fe = s2(G2) ? this._toVariables({ semantic: G2 }, n) : {}, ye = s2(H2) ? this._toVariables({ light: H2 }, n) : {}, Se = s2(I) ? this._toVariables({ dark: I }, n) : {}, [Me, ze] = [(R = W2.declarations) != null ? R : "", W2.tokens], [Ke, Xe] = [(T = q2.declarations) != null ? T : "", q2.tokens || []], [Ge, Ue] = [(j = Z.declarations) != null ? j : "", Z.tokens || []], [Be, Ie] = [(O = pe.declarations) != null ? O : "", pe.tokens || []], [He, We] = [(M = fe.declarations) != null ? M : "", fe.tokens || []], [qe, Ze] = [(z2 = ye.declarations) != null ? z2 : "", ye.tokens || []], [Fe, Je] = [(V = Se.declarations) != null ? V : "", Se.tokens || []];
  ...
  if (s2(t) && r.transform !== "strict") {
    let y = e.replace("-directive", ""), m2 = t, { colorScheme: R, extend: T, css: j } = m2, O = v2(m2, ["colorScheme", "extend", "css"]), d = T || {}, { colorScheme: M } = d, z2 = v2(d, ["colorScheme"]), u = R || {}, { dark: V } = u, L = v2(u, ["dark"]), g2 = M || {}, { dark: te } = g2, re2 = v2(g2, ["dark"]), K2 = s2(O) ? this._toVariables({ [y]: h(h({}, O), z2) }, r) : {}, A2 = s2(L) ? this._toVariables({ [y]: h(h({}, L), re2) }, r) : {}, X = s2(V) ? this._toVariables({ [y]: h(h({}, V), te) }, r) : {}, [G2, U] = [(f2 = K2.declarations) != null ? f2 : "", K2.tokens || []], [B, I] = [(x2 = A2.declarations) != null ? x2 : "", A2.tokens || []], [H2, W2] = [(p = X.declarations) != null ? p : "", X.tokens || []], q2 = this.transformCSS(y, `${G2}${B}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y, H2, "dark", "variable", r, i2, a2, n);
    ...
    Object.entries(l2).forEach(([m2, d]) => {
      ...
      i(d) ? n(d, u, g2) : (i2[u] || (i2[u] = { paths: [], computed: (f2, x2 = {}, p = []) => {
        ...
        if (f2 && f2 !== "none") for (let y = 0; y < i2[u].paths.length; y++) {
          let R = i2[u].paths[y];
          if (R.scheme === f2) return R.computed(f2, x2.binding, p);
        }
...
//# sourceMappingURL=chunk-XGACE7QG.js.map
