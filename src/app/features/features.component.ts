import { Component, ViewEncapsulation , OnInit, HostListener, CUSTOM_ELEMENTS_SCHEMA } from '@angular/core';
...
@Component({
  ...
  imports: [CommonModule,FooterComponent,RouterModule,
    DefaultHeaderComponent,FormsModule,ReactiveFormsModule
  ],
...
export class FeaturesComponent implements OnInit{
  ...
  constructor(
    ...
    this.common.base.subscribe((res: string) => {
      ...
      this.scrollToTop();
    //Loader
      if(this.base === 'index' || this.base === 'index-2' || this.base === 'index-3' || this.base === 'index-4'
        || this.base === 'index-5' || this.base === 'index-6' || this.page === 'index-rtl'
      ){
